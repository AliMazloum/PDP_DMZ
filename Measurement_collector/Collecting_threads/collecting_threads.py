...
def collect_throughput_alpha0():
    measurements_throughput = Measurements(60017)
...
collect_measurements_thread = threading.Thread(target=collect_measurements, name="collect_measurements")
...
collect_throughput_alpha0_thread = threading.Thread(target=collect_throughput_alpha0, name="collect_throughput_alpha0")
