...
sock_60017 = socket.socket()         # throughput alpha 0.05
port = 60017                  
sock_60017.connect((host, port))
        ...
        try:
            for flow_id in long_flows.copy():
                if flow_id not in throughput_alerted_flows:     
                    ...
                    send_data(metric_name,metric_value,to_sleep=False,flow_id=flow_id,socket=sock_60017)
